...
GEM5_DIR=/nobackup/gem5							# Install location of gem5
SPEC_DIR=/u/s/h/shyamm/spec2006/spec_cpu2006					# Install location of your SPEC2006 benchmarks
##################################################################
...
RUN_DIR=$SPEC_DIR/benchspec/CPU2006/$BENCHMARK_CODE/run/run_base_ref\_i386-m32-gcc42-nn.0000		# Run directory for the selected SPEC benchmark
